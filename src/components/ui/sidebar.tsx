  ...
  (
    ...
    return (
      <aside
        ...
        data-state={state}
        className={cn(
          "hidden md:flex flex-col z-30 h-screen bg-sidebar text-sidebar-foreground transition-all duration-300 ease-in-out",
...
>(
  (
    ...
    const buttonContent = (
      <>
        {children}
        <span className={cn(state === 'collapsed' ? "sr-only" : "flex-1 text-left")}>
    ...
    const button = (
       <Comp
        ...
        {...props}
      >
        {/* Pass children directly, but filter out the text span for collapsed state */}
