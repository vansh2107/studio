...
export function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-14 items-center gap-4 bg-orange-gradient-horizontal px-4 text-white shadow-[0_2px_6px_rgba(0,0,0,0.05)] sm:h-16 sm:px-6">
