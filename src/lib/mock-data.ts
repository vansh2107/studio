...
export const clients: Client[] = [
    // Customer for A1
    {
        ...
        anniversaryDate: '2010-12-01',
        panFileName: 'Rahul_Mehta_PAN.pdf',
        panPhotoUrl: '#',
    },
     // Customer 1 for A4
    {
        ...
        aadhaarFileName: 'Mehul_Aadhaar.pdf',
        aadhaarPhotoUrl: '#',
    },
    // Customer 2 for A4
    {
    ...
    // Customer for A6
    {
        ...
        panFileName: 'Suresh_Kumar_PAN.pdf',
        panPhotoUrl: '#',
        aadhaarFileName: 'Suresh_Aadhaar.pdf',
        aadhaarPhotoUrl: '#',
        otherDocumentFileName: 'Passport.pdf',
        otherDocumentUrl: '#',
    },
];
...
export const familyMembers: FamilyMember[] = [
  // Rahul Mehta's Family (client-1)
  { id: 'fm-1-1', clientId: 'client-1', firstName: 'Anita', lastName: 'Mehta', relation: 'Spouse', phoneNumber: '9876543210', emailId: 'anita.mehta@example.com', dateOfBirth: '1987-02-14', address: 'Mumbai, India', panFileName: 'Anita_PAN.pdf', panPhotoUrl: '#' },
  { id: 'fm-1-2', clientId: 'client-1', firstName: 'Aarav', lastName: 'Mehta', relation: 'Son', phoneNumber: '9876543211', emailId: 'aarav.mehta@example.com', dateOfBirth: '2015-10-10', address: 'Mumbai, India' },

  // Mehul Patel's Family (client-2)
  { id: 'fm-2-1', clientId: 'client-2', firstName: 'Bhavika', lastName: 'Patel', relation: 'Spouse', phoneNumber: '9123456780', emailId: 'bhavika.p@example.com', dateOfBirth: '1990-07-22', address: 'Ahmedabad, Gujarat' },
  { id: 'fm-2-2', clientId: 'client-2', firstName: 'Riya', lastName: 'Patel', relation: 'Daughter', phoneNumber: '9123456781', emailId: 'riya.p@example.com', dateOfBirth: '2018-04-01', address: 'Ahmedabad, Gujarat' },

  // Nirav Shah's Family (client-4)
  { id: 'fm-4-1', clientId: 'client-4', firstName: 'Pooja', lastName: 'Shah', relation: 'Spouse', phoneNumber: '9825098250', emailId: 'pooja.s@example.com', dateOfBirth: '1984-01-30', address: 'Surat, Gujarat', panFileName: 'Pooja_Shah_PAN.pdf', panPhotoUrl: '#' },
  { id: 'fm-4-2', clientId: 'client-4', firstName: 'Dev', lastName: 'Shah', relation: 'Son', phoneNumber: '', emailId: '', dateOfBirth: '2016-09-15', address: 'Surat, Gujarat' },

  // Suresh Kumar's Family (client-3)
  { id: 'fm-3-1', clientId: 'client-3', firstName: 'Neha', lastName: 'Kumar', relation: 'Spouse', phoneNumber: '9998887771', emailId: 'neha.k@example.com', dateOfBirth: '1983-09-05', address: 'Bangalore, Karnataka' },
  { id: 'fm-3-2', clientId: 'client-3', firstName: 'Rohan', lastName: 'Kumar', relation: 'Son', phoneNumber: '9998887772', emailId: 'rohan.k@example.com', dateOfBirth: '2012-06-20', address: 'Bangalore, Karnataka' },
];
